...
const Navbar = () => {
  ...
  const navOptions = (
    <>
      ...
      <NavLink
        to="/products"
        className="hover:text-gray-900  font-semi-bold navLinks"
      >
        <span className="pb-2 flex items-center gap-2">
          <AiFillProduct />
          Products
      ...
      <NavLink to='/contact' className="hover:text-gray-900  font-semi-bold navLinks">
        <span className="pb-2 flex items-center gap-2">
          <MdAddIcCall></MdAddIcCall>Contact Us
        </span>
      </NavLink>
    </>
  );
        ...
        <div className="navbar-end flex justify-end items-center gap-10">
          ...
          <div>
            <details className="dropdown">
              ...
              <ul className="px-4  right-1 border-none dropdown-content z-[1] bg-gradient-to-r from-transparent to-red-400 rounded-e-lg ">
                <li>
                  {user ? (
